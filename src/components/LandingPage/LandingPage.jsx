...
function LandingPage() {
    return (
        <div className='LandingPage overflow-hidden antialiased font-sans text-gray-900 bg-transparent'>
            <main className="w-full">
                {/* start hero */}
                <div className="bg-gray-100">
                    <section className="cover  px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex
        items-center min-h-screen">
                        ...
                        <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
                            <div>
                                ...
                                <p className="text-blue-100 text-left text-xl md:text-2xl leading-snug mt-4">Experience a new level of convenience and control over your healthcare with our HealthNet Management System.</p>
                                <a href="#" onClick={(e) => {
                                              e.preventDefault();
                                              navigator.geolocation.getCurrentPosition(
                                              (position) => {
                                              const url = `https://www.google.com/maps/search/?api=1&query=My+Location&basemap=terrain&layer=c&cbp=13,0,0,0,0&markers=size:tiny%7Ccolor:red%7C${position.coords.latitude},${position.coords.longitude}`;
...
>
                ...
                <h1 className="text-3xl text-center pt-0 lg:py-12 leading-tight font-bold mt-4">Features</h1>
                    <div className="flex flex-col lg:flex-row lg:-mx-8">
                        <div className="w-full lg:w-1/2 lg:px-8">
                            <h2 className="text-2xl leading-tight font-bold mt-4">Welcome to our HealthNet Management System</h2>
                        ...
                        <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
                            ...
                            <div className="md:flex mt-8">
                                ...
                                <div className="md:ml-8 mt-4 md:mt-0">
                                    ...
                                    <p className="mt-2 leading-relaxed">Whether you're managing a chronic condition, preparing for a routine check-up, or just looking to stay on top of your health, our HealthNet Management System is here to help. Sign up today to start taking control of your health!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="relative bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 text-center md:text-left">
                    <div className="md:flex md:items-center md:justify-center">
                        <h2 className="text-xl font-bold text-white">Get in touch with us today! <br className="block md:hidden" />Call us on: +91-1234567890</h2>
                ...
                <footer className="relative text-left bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                    <div className="flex flex-col md:flex-row">
                        <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                            <h3 className="font-bold text-2xl">HealthNet Management System</h3>
                        ...
                        <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                            ...
                            <p className="text-sm text-gray-400 mt-12">© 2024 HealthNet Management System. <br className="hidden lg:block" />All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </footer>
